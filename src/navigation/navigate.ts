...
const NAVIGATE_RECHARGE_SCREEN: string = 'Recharge'
const NAVIGATE_RECHARGE_HISTORY: string = 'RechargeHistory'
const NAVIGATE_INTERNETBANKING_SCREEN: string = 'InternetBanking'
...
export {
  ...
  NAVIGATE_HOME,
  NAVIGATE_ORDER,
  NAVIGATE_RECHARGE_SCREEN,
  NAVIGATE_RECHARGE_HISTORY,
  NAVIGATE_INTERNETBANKING_SCREEN
};
